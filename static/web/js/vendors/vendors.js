!(function (e, t) {
    ...
    (E.extend = E.fn.extend =
      function () {
        var e,
          ...
          s = arguments.length,
          u = !1;
        for ("boolean" == typeof o && ((u = o), (o = arguments[a] || {}), a++), "object" == typeof o || g(o) || (o = {}), a === s && ((o = this), a--); a < s; a++) if (null != (e = arguments[a])) for (t in e) (n = e[t]), "__proto__" !== t && o !== n && (u && n && (E.isPlainObject(n) || (r = Array.isArray(n))) ? ((i = o[t]), (i = r && !Array.isArray(i) ? [] : r || E.isPlainObject(i) ? i : {}), (r = !1), (o[t] = E.extend(u, i, n))) : void 0 !== n && (o[t] = n));
        return o;
      }),
    E.extend({
      ...
      if (!r && (T(e), (e = e || C), E)) {
        ...
        if (d.qsa && !q[t + " "] && (!m || !m.test(t)) && (1 !== f || "object" !== e.nodeName.toLowerCase())) {
          if (((l = t), (c = e), 1 === f && (G.test(t) || V.test(t)))) {
            for (((c = (re.test(t) && ge(e.parentNode)) || e) === e && d.scope) || ((a = e.getAttribute("id")) ? (a = a.replace(oe, p)) : e.setAttribute("id", (a = S))), i = (u = h(t)).length; i--; ) u[i] = (a ? "#" + a : ":scope") + " " + me(u[i]);
            l = u.join(",");
          }
          try {
          ...
          e != C &&
            ...
            (L = t
              ? function (e, t) {
                  ...
                  return n || (1 & (n = (e.ownerDocument || e) == (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || (!d.sortDetached && t.compareDocumentPosition(e) === n) ? (e == C || (e.ownerDocument == x && v(x, e)) ? -1 : t == C || (t.ownerDocument == x && v(x, t)) ? 1 : u ? I(u, e) - I(u, t) : 0) : 4 & n ? -1 : 1);
                }
              : function (e, t) {
                  if (e === t) return (l = !0), 0;
                  var n,
            ...
            return 1 === g && 0 === y
              ...
              : function (e, t, n) {
                  ...
                  if (c) {
                    ...
                    } else if (!1 === (d = p ? (s = (r = (i = (o = (a = e)[S] || (a[S] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] || [])[0] === k && r[1]) : d)) for (; (a = (++s && a && a[l]) || (d = s = 0) || u.pop()) && ((x ? a.nodeName.toLowerCase() !== f : 1 !== a.nodeType) || !++d || (p && ((i = (o = a[S] || (a[S] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] = [k, d]), a !== e)); );
      ...
      (h = se.tokenize =
        function (e, t) {
          ...
          for (a = e, s = [], u = b.preFilter; a; ) {
            for (o in ((n && !(r = X.exec(a))) || (r && (a = a.slice(r[0].length) || a), s.push((i = []))), (n = !1), (r = V.exec(a)) && ((n = r.shift()), i.push({ value: n, type: r[0].replace(U, " ") }), (a = a.slice(n.length))), b.filter)) !(r = J[o].exec(a)) || (u[o] && !(r = u[o](r))) || ((n = r.shift()), i.push({ value: n, type: o, matches: r }), (a = a.slice(n.length)));
            if (!n) break;
          }
                ...
                for (
                  ...
                  if ((n = b.relative[t[u].type])) f = [ve(xe(f), n)];
                    ...
                    if ((n = b.filter[t[u].type].apply(null, t[u].matches))[S]) {
                      ...
                      return we(1 < u && xe(f), 1 < u && me(t.slice(0, u - 1).concat({ value: " " === t[u - 2].type ? "*" : "" })).replace(U, "$1"), n, u < i && e(t.slice(u, i)), i < o && e((t = t.slice(i))), i < o && me(t));
                    }
                    f.push(n);
                  }
                return xe(f);
                ...
                return function () {
                  function e() {
                    ...
                    if (!(i < u)) {
                      ...
                      (t = e && ("object" == typeof e || "function" == typeof e) && e.then), g(t) ? (s ? t.call(e, l(u, o, R, s), l(u, o, M, s)) : (u++, t.call(e, l(u, o, R, s), l(u, o, M, s), l(u, o, R, o.notifyWith)))) : (a !== R && ((n = void 0), (r = [e])), (s || o.resolveWith)(n, r));
                    }
                  }
                  var n = this,
                    r = arguments,
  ...
  (E.event = {
    ...
    dispatch: function (e) {
      ...
      if (((s.delegateTarget = this), !e.preDispatch || !1 !== e.preDispatch.call(this, s))) {
        for (o = E.event.handlers.call(this, s, u), t = 0; (r = o[t++]) && !s.isPropagationStopped(); ) for (s.currentTarget = r.elem, n = 0; (i = r.handlers[n++]) && !s.isImmediatePropagationStopped(); ) (s.rnamespace && !1 !== i.namespace && !s.rnamespace.test(i.namespace)) || ((s.handleObj = i), (s.data = i.data), void 0 !== (i = ((E.event.special[i.origType] || {}).handle || i.handler).apply(r.elem, a)) && !1 === (s.result = i) && (s.preventDefault(), s.stopPropagation()));
  ...
  function qe(n, r, i, o) {
    ...
    if (f && ((t = (e = me(r, n[0].ownerDocument, !1, n, o)).firstChild), 1 === e.childNodes.length && (e = t), t || o)) {
      ...
      if (s) for (l = a[a.length - 1].ownerDocument, E.map(a, je), c = 0; c < s; c++) (u = a[c]), pe.test(u.type || "") && !Y.access(u, "globalEval") && E.contains(l, u) && (u.src && "module" !== (u.type || "").toLowerCase() ? E._evalUrl && !u.noModule && E._evalUrl(u.src, { nonce: u.nonce || u.getAttribute("nonce") }, l) : b(u.textContent.replace(ke, ""), u, l));
    }
    return n;
  }
  function Le(e, t, n) {
  ...
  E.extend({
    ...
    clone: function (e, t, n) {
      var r,
        ...
        c = e.cloneNode(!0),
        f = ie(e);
      if (!(x.noCloneChecked || (1 !== e.nodeType && 11 !== e.nodeType) || E.isXMLDoc(e))) for (a = he(c), r = 0, i = (o = he(e)).length; r < i; r++) (s = o[r]), (u = a[r]), (l = void 0), "input" === (l = u.nodeName.toLowerCase()) && ce.test(s.type) ? (u.checked = s.checked) : ("input" !== l && "textarea" !== l) || (u.defaultValue = s.defaultValue);
      if (t)
  ...
  function Ue() {
    var e;
    $e && ((Be.style.cssText = "position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0"), ($e.style.cssText = "position:relative;display:block;box-sizing:border-box;overflow:scroll;margin:auto;border:1px;padding:1px;width:60%;top:1%"), re.appendChild(Be).appendChild($e), (e = T.getComputedStyle($e)), (Pe = "1%" !== e.top), (Fe = 12 === Xe(e.marginLeft)), ($e.style.right = "60%"), (Ie = 36 === Xe(e.right)), (Re = 36 === Xe(e.width)), ($e.style.position = "absolute"), (Me = 12 === Xe($e.offsetWidth / 3)), re.removeChild(Be), ($e = null));
  }
  function Xe(e) {
  ...
  function Ve(e, t, n) {
    var r,
      i,
      o = e.style;
    return (n = n || He(e)) && ("" !== (i = n.getPropertyValue(t) || n[t]) || ie(e) || (i = E.style(e, t)), !x.pixelBoxStyles() && _e.test(i) && ze.test(t) && ((r = o.width), (e = o.minWidth), (t = o.maxWidth), (o.minWidth = o.maxWidth = o.width = i), (i = n.width), (o.width = r), (o.minWidth = e), (o.maxWidth = t))), void 0 !== i ? i + "" : i;
  }
  function Ge(e, t) {
    return {
      get: function () {
  ...
  E.extend({
    ...
    style: function (e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        ...
        "string" === (o = typeof n) && (i = te.exec(n)) && i[1] && ((n = se(e, t, i)), (o = "number")), null != n && n == n && ("number" !== o || u || (n += (i && i[3]) || (E.cssNumber[s] ? "" : "px")), x.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), (a && "set" in a && void 0 === (n = a.set(e, n, r))) || (u ? l.setProperty(t, n) : (l[t] = n)));
      }
    },
      ...
      E.cssHooks[s] = {
        ...
        set: function (e, t, n) {
          var r,
            ...
            n = n ? it(e, s, n, a, i) : 0;
          return a && o && (n -= Math.ceil(e["offset" + s[0].toUpperCase() + s.slice(1)] - parseFloat(i[s]) - it(e, s, "border", !1, i) - 0.5)), n && (r = te.exec(t)) && "px" !== (r[3] || "px") && ((e.style[s] = t), (t = E.css(e, s))), rt(0, t, n);
        },
      };
    }),
  ...
  ($t.href = kt.href),
    E.extend({
      ...
      ajax: function (e, t) {
        ...
        (l = h.url.replace(Ot, "")),
        h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(Ht, "+")) : ((i = h.url.slice(l.length)), h.data && (h.processData || "string" == typeof h.data) && ((l += (Nt.test(l) ? "&" : "?") + h.data), delete h.data), !1 === h.cache && ((l = l.replace(Pt, "$1")), (i = (Nt.test(l) ? "&" : "?") + "_=" + At.guid++ + i)), (h.url = l + i)),
        ...
        function w(e, t, n, r) {
          ...
          p ||
            ...
            r ? (h.ifModified && ((n = b.getResponseHeader("Last-Modified")) && (E.lastModified[l] = n), (n = b.getResponseHeader("etag")) && (E.etag[l] = n)), 204 === e || "HEAD" === h.type ? (s = "nocontent") : 304 === e ? (s = "notmodified") : ((s = a.state), (i = a.data), (r = !(o = a.error)))) : ((o = s), (!e && s) || ((s = "error"), e < 0 && (e = 0))),
            (b.status = e),
            (b.statusText = (t || s) + ""),
  ...
  E.ajaxSetup({
    ...
    (E.parseHTML = function (e, t, n) {
      return "string" != typeof e ? [] : ("boolean" == typeof t && ((n = t), (t = !1)), t || (x.createHTMLDocument ? (((r = (t = C.implementation.createHTMLDocument("")).createElement("base")).href = C.location.href), t.head.appendChild(r)) : (t = C)), (r = !n && []), (n = N.exec(e)) ? [t.createElement(n[1])] : ((n = me([e], t, r)), r && r.length && E(r).remove(), E.merge([], n.childNodes)));
      var r;
    }),
    ...
    (E.offset = {
      setOffset: function (e, t, n) {
        var r,
          ...
          u = E(e),
          l = {};
        "static" === s && (e.style.position = "relative"), (o = u.offset()), (r = E.css(e, "top")), (a = E.css(e, "left")), (a = ("absolute" === s || "fixed" === s) && -1 < (r + a).indexOf("auto") ? ((i = (s = u.position()).top), s.left) : ((i = parseFloat(r) || 0), parseFloat(a) || 0)), null != (t = g(t) ? t.call(e, n, E.extend({}, o)) : t).top && (l.top = t.top - o.top + i), null != t.left && (l.left = t.left - o.left + a), "using" in t ? t.using.call(e, l) : u.css(l);
      },
    }),
    E.fn.extend({
      offset: function (t) {
      ...
      E.each({ padding: "inner" + a, content: s, "": "outer" + a }, function (r, o) {
        E.fn[o] = function (e, t) {
          ...
          return $(
            ...
            function (e, t, n) {
              var r;
              return y(e) ? (0 === o.indexOf("outer") ? e["inner" + a] : e.document.documentElement["client" + a]) : 9 === e.nodeType ? ((r = e.documentElement), Math.max(e.body["scroll" + a], r["scroll" + a], e.body["offset" + a], r["offset" + a], r["client" + a])) : void 0 === n ? E.css(e, t, i) : E.style(e, t, n, i);
            },
            s,
            n ? e : void 0,
            n
...
!(function (e, t) {
      ...
      return (
        (a.show = function () {
          var e,
            ...
            r,
            i = this;
          (this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && d.default(this._element).hasClass(u)) ||
            d.default(this._element).hasClass("disabled") ||
            ((r = d.default(this._element).closest(".nav, .list-group")[0]),
            (t = o.default.getSelectorFromElement(this._element)),
            r && ((l = "UL" === r.nodeName || "OL" === r.nodeName ? m : c), (a = (a = d.default.makeArray(d.default(r).find(l)))[a.length - 1])),
            (n = d.default.Event("hide.bs.tab", { relatedTarget: this._element })),
            (l = d.default.Event("show.bs.tab", { relatedTarget: a })),
            a && d.default(a).trigger(n),
            ...
            l.isDefaultPrevented() ||
              ...
              (r = function () {
                var e = d.default.Event("hidden.bs.tab", { relatedTarget: i._element }),
                  t = d.default.Event("shown.bs.tab", { relatedTarget: a });
                d.default(a).trigger(e), d.default(i._element).trigger(t);
              }),
              e ? this._activate(e, e.parentNode, r) : r()));
        }),
        (a.dispose = function () {
          d.default.removeData(this._element, r), (this._element = null);
        }),
        (a._activate = function (e, t, a) {
          var n = this,
            l = (!t || ("UL" !== t.nodeName && "OL" !== t.nodeName) ? d.default(t).children(c) : d.default(t).find(m))[0],
            r = a && l && d.default(l).hasClass(f),
            t = function () {
              return n._transitionComplete(e, l, a);
            };
          l && r ? ((r = o.default.getTransitionDurationFromElement(l)), d.default(l).removeClass(s).one(o.default.TRANSITION_END, t).emulateTransitionEnd(r)) : t();
        }),
        (a._transitionComplete = function (e, t, a) {
          var n;
          t && (d.default(t).removeClass(u), (n = d.default(t.parentNode).find("> .dropdown-menu .active")[0]) && d.default(n).removeClass(u), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !1)),
            d.default(e).addClass(u),
            "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !0),
            o.default.reflow(e),
            e.classList.contains(f) && e.classList.add(s),
            e.parentNode && d.default(e.parentNode).hasClass("dropdown-menu") && ((t = d.default(e).closest(".dropdown")[0]) && ((t = [].slice.call(t.querySelectorAll(".dropdown-toggle"))), d.default(t).addClass(u)), e.setAttribute("aria-expanded", !0)),
            a && a();
        }),
        (n._jQueryInterface = function (a) {
          return this.each(function () {
            var e = d.default(this),
              t = e.data(r);
            if ((t || ((t = new n(this)), e.data(r, t)), "string" == typeof a)) {
              if (void 0 === t[a]) throw new TypeError('No method named "' + a + '"');
              t[a]();
            }
          });
        }),
  ...
  return (
    d.default(document).on("click.bs.tab.data-api", '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function (e) {
      e.preventDefault(), h._jQueryInterface.call(d.default(this), "show");
    }),
    (d.default.fn[n] = h._jQueryInterface),
    (d.default.fn[n].Constructor = h),
    (d.default.fn[n].noConflict = function () {
      return (d.default.fn[n] = i), h._jQueryInterface;
    }),
    h
  );
});
!(function (t, e) {
  ...
  var u = {
    ...
    getTransitionDurationFromElement: function (t) {
      ...
      var e = o.default(t).css("transition-duration"),
        ...
        r = parseFloat(e),
        t = parseFloat(n);
      return r || t ? ((e = e.split(",")[0]), (n = n.split(",")[0]), 1e3 * (parseFloat(e) + parseFloat(n))) : 0;
    },
    reflow: function (t) {
      return t.offsetHeight;
    },
    triggerTransitionEnd: function (t) {
      o.default(t).trigger(n);
    },
  ...
  return (
    u.jQueryDetection(),
    (o.default.fn.emulateTransitionEnd = r),
...
!(function (e, t) {
  ...
  var s = "collapse",
    ...
    y = (function () {
      function i(t, e) {
        ...
        for (var n = [].slice.call(document.querySelectorAll(p)), l = 0, a = n.length; l < a; l++) {
          var i = n[l],
            r = o.default.getSelectorFromElement(i),
            s = [].slice.call(document.querySelectorAll(r)).filter(function (e) {
              return e === t;
            });
      ...
      return (
        (n.toggle = function () {
          r.default(this._element).hasClass(c) ? this.hide() : this.show();
        }),
        (n.show = function () {
          var e,
            t,
          ...
          this._isTransitioning ||
            ...
            ((l =
              this._parent &&
              0 ===
                (l = [].slice.call(this._parent.querySelectorAll(".show, .collapsing")).filter(function (e) {
                  return "string" == typeof a._config.parent ? e.getAttribute("data-parent") === a._config.parent : e.classList.contains(g);
                })).length
                ? null
                : l) &&
              (n = r.default(l).not(this._selector).data(u)) &&
              n._isTransitioning) ||
            ((e = r.default.Event("show.bs.collapse")),
            r.default(this._element).trigger(e),
            e.isDefaultPrevented() ||
              (l && (i._jQueryInterface.call(r.default(l).not(this._selector), "hide"), n || r.default(l).data(u, null)),
              (t = this._getDimension()),
              r.default(this._element).removeClass(g).addClass(h),
              (this._element.style[t] = 0),
              this._triggerArray.length && r.default(this._triggerArray).removeClass(_).attr("aria-expanded", !0),
              this.setTransitioning(!0),
              (n = "scroll" + (t[0].toUpperCase() + t.slice(1))),
              (l = o.default.getTransitionDurationFromElement(this._element)),
              r
                ...
                .one(o.default.TRANSITION_END, function () {
                  r
                    ...
                    r.default(a._element).trigger("shown.bs.collapse");
                })
        ...
        (n.hide = function () {
          var e = this;
          if (!this._isTransitioning && r.default(this._element).hasClass(c)) {
            ...
            if ((r.default(this._element).trigger(t), !t.isDefaultPrevented())) {
              ...
              if (0 < n)
                for (var l = 0; l < n; l++) {
                  var a = this._triggerArray[l],
                    i = o.default.getSelectorFromElement(a);
                  null !== i && (r.default([].slice.call(document.querySelectorAll(i))).hasClass(c) || r.default(a).addClass(_).attr("aria-expanded", !1));
                }
              this.setTransitioning(!0);
              this._element.style[t] = "";
              t = o.default.getTransitionDurationFromElement(this._element);
              r.default(this._element)
                .one(o.default.TRANSITION_END, function () {
                  e.setTransitioning(!1), r.default(e._element).removeClass(h).addClass(g).trigger("hidden.bs.collapse");
                })
        ...
        (n.dispose = function () {
          r.default.removeData(this._element, u), (this._config = null), (this._parent = null), (this._element = null), (this._triggerArray = null), (this._isTransitioning = null);
        }),
        (n._getConfig = function (e) {
          return ((e = a({}, f, e)).toggle = Boolean(e.toggle)), o.default.typeCheckConfig(s, e, d), e;
        }),
        ...
        (n._getParent = function () {
          var e,
            n = this;
          o.default.isElement(this._config.parent) ? ((e = this._config.parent), void 0 !== this._config.parent.jquery && (e = this._config.parent[0])) : (e = document.querySelector(this._config.parent));
        ...
        (n._addAriaAndCollapsedClass = function (e, t) {
          e = r.default(e).hasClass(c);
          t.length && r.default(t).toggleClass(_, !e).attr("aria-expanded", e);
        }),
        (i._getTargetFromElement = function (e) {
          e = o.default.getSelectorFromElement(e);
          return e ? document.querySelector(e) : null;
        }),
        (i._jQueryInterface = function (l) {
          return this.each(function () {
            var e = r.default(this),
              t = e.data(u),
              n = a({}, f, e.data(), "object" == typeof l && l ? l : {});
            if ((!t && n.toggle && "string" == typeof l && /show|hide/.test(l) && (n.toggle = !1), t || ((t = new i(this, n)), e.data(u, t)), "string" == typeof l)) {
              if (void 0 === t[l]) throw new TypeError('No method named "' + l + '"');
              t[l]();
            }
          });
        }),
  ...
  return (
    r.default(document).on("click.bs.collapse.data-api", p, function (e) {
      "A" === e.currentTarget.tagName && e.preventDefault();
      var n = r.default(this),
        e = o.default.getSelectorFromElement(this),
        e = [].slice.call(document.querySelectorAll(e));
      r.default(e).each(function () {
        var e = r.default(this),
          t = e.data(u) ? "toggle" : n.data();
        y._jQueryInterface.call(e, t);
      });
    }),
    (r.default.fn[s] = y._jQueryInterface),
    (r.default.fn[s].Constructor = y),
    (r.default.fn[s].noConflict = function () {
      return (r.default.fn[s] = i), y._jQueryInterface;
    }),
    y
  );
});
